...
Partial Class ProductVersions
    ...
    ''' <summary>
    ''' Occurs when an image swatch is selected from within the option control.
    ''' </summary>
    ''' <param name="OptionParentID">Option group ID</param>
    ''' <param name="OptionId">Option ID</param>
    ''' <param name="OptionText">Option display text</param>
    ''' <remarks></remarks>
    Protected Sub OptionSwatchChanged(ByVal OptionParentID As Integer, OptionId As Integer, OptionText As String) Handles UC_OptionsContainer.Event_OptionSwatchChanged
        ' Bubble to the containing control.
        RaiseEvent OptionsSwatchChanged(OptionParentID, OptionId, OptionText)
    End Sub

    Public Event OptionsSwatchChanged(ByVal OptionParentID As Integer, OptionId As Integer, OptionText As String)
