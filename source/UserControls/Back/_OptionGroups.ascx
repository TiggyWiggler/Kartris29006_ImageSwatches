                                ...
                                <li><span class="Kartris-DetailsView-Name">
                                    ...
                                    <span class="Kartris-DetailsView-Value">
                                        ...
                                        <asp:DropDownList ID="ddlDisplayType" runat="server">
                                            ...
                                            <asp:ListItem Text="Swatches" Value="s" />
                                        </asp:DropDownList>
                                    </span></li>
                                <li><span class="Kartris-DetailsView-Name">
                                    ...
                                    <li><span class="Kartris-DetailsView-Name">
                                      ...
                                      <asp:PlaceHolder ID="phdNewSwatch" runat="server">
                                            ...
                                            <span class="Kartris-DetailsView-Value">
                                                ...
                                                <_user:_FileUploader runat="server" id="UC_SwatchFileUploader" AllowMultiple="false" OneItemOnly="true" ImageType="enum_OptionSwatch" ItemID='<%# Eval("OPT_ID") %>' ParentID='<%# Eval("OPT_OptionGroupID") %>'/>
                                            </span>
                                            </li>
                                        </asp:PlaceHolder>
                                </ul>
