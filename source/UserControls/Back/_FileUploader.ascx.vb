...
generateNewName:
                ...
                If c_blnOneFileOnly Then
                    ...
                    strTempName = ItemID & Path.GetExtension(FileNames(I))
                Else
                ...
                If Not File.Exists(Server.MapPath(litInfo.Text & strTempName)) Then
                    _UC_UploaderPopup.SaveFile(Server.MapPath(litInfo.Text & strTempName), I, I < (FileNames.Count - 1))
