...
Partial Class OptionsContainer
    ...
    Protected Sub UCEvent_Options_IndexChaged(ByVal sender As Options) Handles UC_HiddenOption.Option_IndexChanged
        ...
        ' Inform the parent control that an image swatch has been selected.
        If CType(sender, Options).GetControlType = "Swatch" Then
            RaiseEvent Event_OptionSwatchChanged(CType(sender, Options).GetOptionGroupID, CType(sender, Options).GetSelectedValues, CType(sender, Options).GetSelectedText)
        End If
    ...
    ''' <summary>
    ''' Triggered if an image swatch is selected.
    ''' </summary>
    ''' <param name="OptionParentID">Option group ID</param>
    ''' <param name="OptionId">Option ID</param>
    ''' <param name="OptionText">Option display text</param>
    ''' <remarks></remarks>
    Public Event Event_OptionSwatchChanged(ByVal OptionParentID As Integer, OptionId As Integer, OptionText As String)
