...
Partial Class ImageViewer
    ...
    Private _blnRedrawn As Boolean = False     ' Did we add or remove image controls during the call lifecycle
    ...
    Protected Sub Page_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ' Register the click events on startup, required because partial page postbacks from selecting image swatches do 
        ' not trigger the script on this page that sets up the click events otherwise.
        ScriptManager.RegisterStartupScript(Page, Me.GetType(), "InitClickEvents", "InitImageClickEvents();", True)
    End Sub
End Class
